  ...
  <section class="stats__container"> 
    <header>
      ...
      <nav class="leg-nav">
        <ul>
          <li>
            <a v-on:click.prevent="prevRun()" href="#"><svg width="8px" height="11px" viewBox="0 0 8 11" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <li>
            <a v-on:click.prevent="nextRun()" href="#"><svg width="8px" height="11px" viewBox="0 0 8 11" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
